...
async def generate_ai_insights(search_query: SearchQuery):
    ...
    top_indices, similarity_scores = find_similar_documents(search_query.query)
    ...
    posts = []
    total_chars = 0
    char_limit = 1000  # Limit context size to avoid token issues
    ...
    for _, post in relevant_posts.iterrows():
        ...
        # Check if adding this post exceeds our character limit
